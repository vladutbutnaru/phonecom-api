...
public class SubaccountsApi {
  ...
  */
  public ListAccountsFull listAccountSubaccounts (Integer accountId, List<String> filtersId, String sortId, Integer limit, Integer offset, String fields) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  "application/json"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (ListAccountsFull) ApiInvoker.deserialize(localVarResponse, "", ListAccountsFull.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void listAccountSubaccounts (Integer accountId, List<String> filtersId, String sortId, Integer limit, Integer offset, String fields, final Response.Listener<ListAccountsFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListAccountsFull) ApiInvoker.deserialize(localVarResponse,  "", ListAccountsFull.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
