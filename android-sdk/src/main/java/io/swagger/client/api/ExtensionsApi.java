...
public class ExtensionsApi {
  ...
  */
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (ListExtensionsFull) ApiInvoker.deserialize(localVarResponse, "", ListExtensionsFull.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void listAccountExtensions (Integer accountId, List<String> filtersId, List<String> filtersExtension, List<String> filtersName, String sortId, String sortExtension, String sortName, Integer limit, Integer offset, String fields, final Response.Listener<ListExtensionsFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListExtensionsFull) ApiInvoker.deserialize(localVarResponse,  "", ListExtensionsFull.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
