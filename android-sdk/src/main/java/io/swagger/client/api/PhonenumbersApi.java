...
public class PhonenumbersApi {
  ...
  */
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (ListPhoneNumbersFull) ApiInvoker.deserialize(localVarResponse, "", ListPhoneNumbersFull.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void listAccountPhoneNumbers (Integer accountId, List<String> filtersId, List<String> filtersName, List<String> filtersPhoneNumber, String sortId, String sortName, String sortPhoneNumber, Integer limit, Integer offset, String fields, final Response.Listener<ListPhoneNumbersFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListPhoneNumbersFull) ApiInvoker.deserialize(localVarResponse,  "", ListPhoneNumbersFull.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
