...
public class ContactsApi {
  ...
  */
  public ListContactsFull listAccountExtensionContacts (Integer accountId, Integer extensionId, List<String> filtersId, List<String> filtersGroupId, List<String> filtersUpdatedAt, String sortId, String sortUpdatedAt, Integer limit, Integer offset, String fields) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (ListContactsFull) ApiInvoker.deserialize(localVarResponse, "", ListContactsFull.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void listAccountExtensionContacts (Integer accountId, Integer extensionId, List<String> filtersId, List<String> filtersGroupId, List<String> filtersUpdatedAt, String sortId, String sortUpdatedAt, Integer limit, Integer offset, String fields, final Response.Listener<ListContactsFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListContactsFull) ApiInvoker.deserialize(localVarResponse,  "", ListContactsFull.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * For more on the input fields, see Account Contacts.
   ...
   * @return ContactFull
  */
  public ContactFull replaceAccountExtensionContact (Integer accountId, Integer extensionId, CreateContactParams data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
   ...
   * @param accountId Account ID   * @param extensionId Extension ID   * @param data Contact data
  */
  public void replaceAccountExtensionContact (Integer accountId, Integer extensionId, CreateContactParams data, final Response.Listener<ContactFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
