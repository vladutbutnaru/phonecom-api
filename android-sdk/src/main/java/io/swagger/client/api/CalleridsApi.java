...
public class CalleridsApi {
  ...
  */
  public ListCallerIdsFull getCallerIds (Integer accountId, Integer extensionId, List<String> filtersNumber, List<String> filtersName, String sortNumber, String sortName, Integer limit, Integer offset, String fields) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  "application/json"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (ListCallerIdsFull) ApiInvoker.deserialize(localVarResponse, "", ListCallerIdsFull.class);
        } else {
           return null;
        }
  ...
  */
  public void getCallerIds (Integer accountId, Integer extensionId, List<String> filtersNumber, List<String> filtersName, String sortNumber, String sortName, Integer limit, Integer offset, String fields, final Response.Listener<ListCallerIdsFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListCallerIdsFull) ApiInvoker.deserialize(localVarResponse,  "", ListCallerIdsFull.class));
