...
public class AvailablenumbersApi {
  ...
  */
  public ListAvailableNumbersFull listAvailablePhoneNumbers (List<String> filtersPhoneNumber, List<String> filtersCountryCode, List<String> filtersNpa, List<String> filtersNxx, List<String> filtersXxxx, List<String> filtersCity, List<String> filtersProvince, List<String> filtersCountry, List<String> filtersPrice, List<String> filtersCategory, List<String> filtersIsTollFree, String sortInternal, String sortPrice, String sortPhoneNumber, Integer limit, Integer offset, String fields) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  "application/json"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (ListAvailableNumbersFull) ApiInvoker.deserialize(localVarResponse, "", ListAvailableNumbersFull.class);
        } else {
           return null;
        }
   ...
   * 
   * 
   * @param filtersPhoneNumber Phone number filter   * @param filtersCountryCode Country Code filter   * @param filtersNpa Area Code filter (North America only)   * @param filtersNxx 2nd set of 3 digits filter (North America only)   * @param filtersXxxx NANP XXXX filter   * @param filtersCity City filter   * @param filtersProvince State or Province (postal code) filter   * @param filtersCountry Country (postal code) filter   * @param filtersPrice Price filter   * @param filtersCategory Category filter   * @param filtersIsTollFree Toll-free status filter   * @param sortInternal Internal (quasi-random) sorting   * @param sortPrice Price sorting   * @param sortPhoneNumber Phone number sorting   * @param limit Max results   * @param offset Results to skip   * @param fields Field set
  */
  public void listAvailablePhoneNumbers (List<String> filtersPhoneNumber, List<String> filtersCountryCode, List<String> filtersNpa, List<String> filtersNxx, List<String> filtersXxxx, List<String> filtersCity, List<String> filtersProvince, List<String> filtersCountry, List<String> filtersPrice, List<String> filtersCategory, List<String> filtersIsTollFree, String sortInternal, String sortPrice, String sortPhoneNumber, Integer limit, Integer offset, String fields, final Response.Listener<ListAvailableNumbersFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListAvailableNumbersFull) ApiInvoker.deserialize(localVarResponse,  "", ListAvailableNumbersFull.class));
