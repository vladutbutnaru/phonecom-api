...
public class ExpressservicecodesApi {
  ...
  */
  public ListExpressServiceCodesFull listAccountExpressSrvCodes (Integer accountId, List<String> filtersId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (ListExpressServiceCodesFull) ApiInvoker.deserialize(localVarResponse, "", ListExpressServiceCodesFull.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void listAccountExpressSrvCodes (Integer accountId, List<String> filtersId, final Response.Listener<ListExpressServiceCodesFull> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ListExpressServiceCodesFull) ApiInvoker.deserialize(localVarResponse,  "", ListExpressServiceCodesFull.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
