...
public class Voicemail  {
  ...
  public boolean equals(Object o) {
    ...
    return (enabled == null ? voicemail.enabled == null : enabled.equals(voicemail.enabled)) &&
        (password == null ? voicemail.password == null : password.equals(voicemail.password)) &&
        (greeting == null ? voicemail.greeting == null : greeting.equals(voicemail.greeting)) &&
        (attachments == null ? voicemail.attachments == null : attachments.equals(voicemail.attachments)) &&
        (notifications == null ? voicemail.notifications == null : notifications.equals(voicemail.notifications)) &&
        (transcription == null ? voicemail.transcription == null : transcription.equals(voicemail.transcription));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (notifications == null ? 0: notifications.hashCode());
    result = 31 * result + (transcription == null ? 0: transcription.hashCode());
    return result;
  }
