...
module SwaggerClient
  class AvailablenumbersApi
    ...
    # @option opts [Integer] :offset Results to skip
    # @option opts [String] :fields Field set
    # @return [Array<(ListAvailableNumbersFull, Fixnum, Hash)>] ListAvailableNumbersFull data, response status code and response headers
    def list_available_phone_numbers_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ListAvailableNumbersFull')
      if @api_client.config.debugging
