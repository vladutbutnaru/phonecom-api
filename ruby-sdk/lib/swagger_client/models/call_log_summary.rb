...
module SwaggerClient
  ...
  class CallLogSummary
    ...
    def hash
      [id, uuid, extension, caller_id, called_number, start_time, created_at, direction, type, call_duration, is_monitored, call_number, final_action, call_recording].hash
    end
