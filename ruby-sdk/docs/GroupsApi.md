...
> ListGroupsFull list_account_extension_contact_groups(account_id, extension_id, , opts)
...
> GroupFull replace_account_extension_contact_group(account_id, extension_id, group_id)
...
begin
  #
  result = api_instance.replace_account_extension_contact_group(account_id, extension_id, group_id)
  p result
rescue SwaggerClient::ApiError => e
