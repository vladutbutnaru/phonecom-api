...
func (a ExpressservicecodesApi) GetAccountExpressSrvCode(accountId int32, codeId int32) (*ExpressServiceCodeFull, *APIResponse, error) {
	...
	path := a.Configuration.BasePath + "/accounts/{account_id}/express-service-codes/{code_id}"
	path = strings.Replace(path, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
	path = strings.Replace(path, "{"+"code_id"+"}", fmt.Sprintf("%v", codeId), -1)
...
func (a ExpressservicecodesApi) ListAccountExpressSrvCodes(accountId int32, filtersId []string) (*ListExpressServiceCodesFull, *APIResponse, error) {
	...
	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/accounts/{account_id}/express-service-codes"
	path = strings.Replace(path, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
