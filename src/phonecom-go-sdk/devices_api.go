 ...
 * @return *ListDevices
 */
func (a DevicesApi) ListAccountDevices(accountId int32, filtersId []string, filtersName []string, sortId string, sortName string, limit int32, offset int32, fields string, page int32) (*ListDevices, *APIResponse, error) {
