...
func (a SchedulesApi) GetAccountSchedule(accountId int32, scheduleId int32) (*ScheduleFull, *APIResponse, error) {
	...
	path := a.Configuration.BasePath + "/accounts/{account_id}/schedules/{schedule_id}"
	path = strings.Replace(path, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
	path = strings.Replace(path, "{"+"schedule_id"+"}", fmt.Sprintf("%v", scheduleId), -1)
...
func (a SchedulesApi) ListAccountSchedules(accountId int32, filtersId []string, filtersName []string, sortId string, sortName string, limit int32, offset int32, fields string) (*ListSchedulesFull, *APIResponse, error) {
	...
	var httpMethod = "Get"
	// create path and map variables
	path := a.Configuration.BasePath + "/accounts/{account_id}/schedules"
	path = strings.Replace(path, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
