...
func (a TrunksApi) CreateAccountTrunk(accountId int32, data CreateTrunkParams) (*TrunkFull, *APIResponse, error) {
	...
	path := a.Configuration.BasePath + "/accounts/{account_id}/trunks"
...
func (a TrunksApi) DeleteAccountTrunk(accountId int32, trunkId int32) (*DeleteTrunk, *APIResponse, error) {
	...
	// create path and map variables
	path := a.Configuration.BasePath + "/accounts/{account_id}/trunks/{trunk_id}"
	path = strings.Replace(path, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
	path = strings.Replace(path, "{"+"trunk_id"+"}", fmt.Sprintf("%v", trunkId), -1)
 ...
 */
func (a TrunksApi) ListAccountTrunks(accountId int32, filtersId []string, filtersName []string, sortId string, sortName string, limit int32, offset int32, fields string) (*ListTrunksFull, *APIResponse, error) {
	...
	var successPayload = new(ListTrunksFull)
	httpResponse, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, fileName, fileBytes)
	if err != nil {
		return successPayload, NewAPIResponse(httpResponse.RawResponse), err
	}
