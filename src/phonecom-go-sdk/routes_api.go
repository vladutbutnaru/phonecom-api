 ...
 * @return *ListRoutes
 */
func (a RoutesApi) ListAccountRoutes(accountId int32, filtersId []string, filtersName []string, sortId string, sortName string, limit int32, offset int32, fields string, page int32) (*ListRoutes, *APIResponse, error) {
