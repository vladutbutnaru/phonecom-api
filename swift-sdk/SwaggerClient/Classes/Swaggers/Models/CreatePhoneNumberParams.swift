...
public class CreatePhoneNumberParams: JSONEncodable {
    /** Phone number */
    public var phoneNumber: AnyObject?
    /** Route lookup object */
    ...
    public var smsForwardingApplication: AnyObject?
    /** Extension lookup object */
    public var smsForwardingExtension: AnyObject?
