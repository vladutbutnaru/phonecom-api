...
+ (instancetype)sharedAPI {
    static SWGExpressservicecodesApi *sharedAPI;
...
///
///  @returns SWGListExpressServiceCodesFull*
///
-(NSNumber*) listAccountExpressSrvCodesWithAccountId: (NSNumber*) accountId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGListExpressServiceCodesFull*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGListExpressServiceCodesFull*)data, error);
                                }
                           }
          ];
}
