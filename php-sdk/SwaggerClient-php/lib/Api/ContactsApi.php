...
class ContactsApi
{
    ...
    public function createAccountExtensionContactWithHttpInfo($account_id, $extension_id, $data = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ContactFull', $httpHeader), $statusCode, $httpHeader);
    ...
    public function deleteAccountExtensionContactWithHttpInfo($account_id, $extension_id, $contact_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\DeleteContact', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
     ...
     * @return \Swagger\Client\Model\ListContactsFull
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $offset Results to skip (optional)
     * @param string $fields Field set (optional)
     * @return Array of \Swagger\Client\Model\ListContactsFull, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function listAccountExtensionContactsWithHttpInfo($account_id, $extension_id, $filters_id = null, $filters_group_id = null, $filters_updated_at = null, $sort_id = null, $sort_updated_at = null, $limit = null, $offset = null, $fields = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ListContactsFull',
                '/accounts/{account_id}/extensions/{extension_id}/contacts'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ListContactsFull', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ListContactsFull', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function replaceAccountExtensionContact($account_id, $extension_id, $data = null)
    {
        list($response) = $this->replaceAccountExtensionContactWithHttpInfo($account_id, $extension_id, $data);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function replaceAccountExtensionContactWithHttpInfo($account_id, $extension_id, $data = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null) {
