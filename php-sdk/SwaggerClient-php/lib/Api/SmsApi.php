...
class SmsApi
{
    ...
    public function createAccountSmsWithHttpInfo($account_id, $data)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\SmsFull', $httpHeader), $statusCode, $httpHeader);
     ...
     *
     * @param int $account_id Account ID (required)
     * @param int $sms_id SMS ID (required)
     * @return \Swagger\Client\Model\SmsFull
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @return \Swagger\Client\Model\ListSmsFull
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $offset Results to skip (optional)
     * @param string $fields Field set (optional)
     * @return Array of \Swagger\Client\Model\ListSmsFull, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function listAccountSmsWithHttpInfo($account_id, $filters_id = null, $filters_direction = null, $filters_from = null, $sort_id = null, $sort_created_at = null, $limit = null, $offset = null, $fields = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ListSmsFull',
                '/accounts/{account_id}/sms'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ListSmsFull', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ListSmsFull', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
