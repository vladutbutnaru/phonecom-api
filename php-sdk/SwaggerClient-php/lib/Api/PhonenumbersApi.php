...
class PhonenumbersApi
{
    ...
    public function createAccountPhoneNumberWithHttpInfo($account_id, $data = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PhoneNumberFull', $httpHeader), $statusCode, $httpHeader);
     ...
     * @return \Swagger\Client\Model\ListPhoneNumbersFull
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param int $offset Results to skip (optional)
     * @param string $fields Field set (optional)
     * @return Array of \Swagger\Client\Model\ListPhoneNumbersFull, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function listAccountPhoneNumbersWithHttpInfo($account_id, $filters_id = null, $filters_name = null, $filters_phone_number = null, $sort_id = null, $sort_name = null, $sort_phone_number = null, $limit = null, $offset = null, $fields = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ListPhoneNumbersFull',
                '/accounts/{account_id}/phone-numbers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ListPhoneNumbersFull', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ListPhoneNumbersFull', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
