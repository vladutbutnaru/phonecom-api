...
class CallerIdPhoneNumber implements ArrayAccess
{
    ...
    public function setType($type)
    {
        ...
        if (!preg_match("extension|application", $type)) {
            throw new \InvalidArgumentException('invalid value for $type when calling CallerIdPhoneNumber., must be conform to the pattern extension|application.');
        }
